...
function generatePassword() {
  ...
  //create arrays to store password and an array to store the possible characters for the password
  ...
  for (let i = 0; i < numCharsToPick; i++) {
    ...
    //choose specific char with a different random number
